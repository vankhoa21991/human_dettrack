...
def mot20_to_coco(DATA_PATH, OUT_PATH=None, SPLITS= ['train_half', 'val_half', 'train', 'test'], HALF_VIDEO=True, CREATE_SPLITTED_ANN=True, CREATE_SPLITTED_DET=True):
    if OUT_PATH is None:
...
def mot17_to_coco(DATA_PATH, OUT_PATH=None, SPLITS= ['train_half', 'val_half', 'train', 'test'], HALF_VIDEO=True, CREATE_SPLITTED_ANN=True, CREATE_SPLITTED_DET=True):
    if OUT_PATH is None:
        OUT_PATH = os.path.join(DATA_PATH, 'annotations')
    os.makedirs(OUT_PATH, exist_ok=True)
...
if __name__ == '__main__':
    ...
    # mot17_to_coco(args.data_path)
    mot20_to_coco(args.data_path)
